...
# This copy created September 8, 2023
# LXC Configuration values modified by Ryan Lubach
# All rights retained by original author(s)
...
echo -e "Loading..."
APP="Plex"
var_disk="50"	# Size of LCXC disk in GB [Original = 8]
var_cpu="2"		# CPU cores assigned to LXC [Original = 2]
var_ram="6144"	# RAM assigned to LXC in MB [Original = 2048]
var_os="ubuntu"
var_version="22.04"
variables
color
